package core.storage.sharedpref;
...
public class SavedPrefs {
    ...
    public static void setPref(Context context, String prefName, Object prefValue, int type) {
        ...
        if (prefValue == null) {
            if (type == TYPE_STRING)
                ...
                edit.putStringSet(prefName, null);
        } else {
            if (type == TYPE_STRING)
                edit.putString(prefName, String.valueOf(prefValue));
            else if (type == TYPE_SET)
                edit.putStringSet(prefName, (LinkedHashSet<String>) prefValue);
        }
        edit.commit();
    }
    ...
    public static Object getPref(Context context, String prefName, String prefDefault, int type) {
        ...
        if (type == TYPE_STRING)
            ...
            return prefs.getStringSet(prefName, null);
        else return null;
    }
}
